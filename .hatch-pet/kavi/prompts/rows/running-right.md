Create one horizontal animation strip for Codex pet `kavi`, state `running-right`.
...
Identity: same pet in every frame: Compact whole-body indigo fox-cat tinkerer; warm amber eyes; cream upward-spark forehead marking; teal scarf attached at the neck; rounded readable silhouette; thoughtful, meticulous, quietly playful; no handheld props.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Polished soft vinyl designer-toy finish, subtle tactile texture, expressive but clean, readable at pet size..
